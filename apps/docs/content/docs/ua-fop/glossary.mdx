---
title: Glossary
description: This glossary provides definitions for all key terms, actors, models, and concepts used in the UA FOP Management System.
---

## Actors & Roles

### FOP Manager
**Role:** Primary administrator of the FOP management system

**Responsibilities:**
- Manages FOP employee records and registration data
- Creates and maintains FOP contracts
- Configures contract types and templates
- Monitors KVED compliance
- Oversees billing and payment processes

**Access Level:** Full access to all FOP functionality
...
### Account Manager
**Role:** Responsible manager assigned to specific FOP employees

**Responsibilities:**
- Manages assigned FOP employees
- Reviews bills and payments for assigned employees
- Ensures compliance for assigned portfolio
- Coordinates with FOPs on contract and payment matters
- Processes batch payments for FOP employees
- Validates payment amounts against bills
- Posts FOP bills after verification
...
- Manages HR contracts
- Sets contract types for employees
...
### FOP Employee
**Role:** Ukrainian individual entrepreneur (contractor)

**Definition:** A natural person registered as FOP (Фізична Особа-Підприємець) in Ukraine, providing services to the company
...
**Related Models:** `hr.employee` (with `is_fop=True`)
...
**Related:** `fop.bill.line`, `account.payment`
...
**Output:** `ir.attachment` records linked to `fop.contract`

---

## Glossary Meta-Information

**Document Version:** 1.0.8 (matches module version)

**Last Updated:** 2025

**Related Documentation:**
- [Level 1 - System Context](./c1.mdx)
...
- **KVED Classifier:** Official Ukrainian economic activity codes
- **Tax Inspection Registry:** DPS (Державна податкова служба)
- **FOP Regulations:** Ukrainian Tax Code, Chapter 1, Section 4

### Odoo Documentation
- [Odoo ORM API](https://www.odoo.com/documentation/17.0/developer/reference/backend/orm.html)
- [Odoo Views](https://www.odoo.com/documentation/17.0/developer/reference/backend/views.html)
