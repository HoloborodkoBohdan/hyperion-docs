...
graph TD;
    ...
    subgraph FOPBackend [FOP Backend]
        ...
        subgraph ServiceLayer [ServiceLayer]
            EmployeeService[<a href='employee-service'>Employee Service - Manages FOP profiles, assignments, and statuses</a>]
            ContractService[<a href='contract-service'>Contract Service - Handles creation, validation, and archiving of contracts</a>]
            ...
            BillingService[<a href='billing-service'>Billing Service - Bill management, posting, and Odoo integration</a>]
        end
    ...
    BillingService --> DatabaseAdapter
    ...
    class EmployeeService,ContractService,PayrollService,ReportService,TaxSyncService,FileService,BillingService serviceLayerStyle
